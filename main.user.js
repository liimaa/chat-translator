...
(function () {
    ...
    */ 
    ...
    var Config = {
        ...
        info: {
            "Supported sites": ["list", "https://github.com/liimaa/chat-translator/blob/master/README.md"],
    ...
    const Ui = (() => {
        ...
        const container = () => {
            ...
            $.on(el3, "click", () => { 
                localStorage.removeItem("ct-config");
    ...
    const App = (() => {
        ...
        const loadConfig = () => {
            var ctct = JSON.parse(localStorage.getItem("ct-config"));
            if(!ctct) {
